...
insert into reply (rcontent, relike, cdate, udate, mno, cno) values ("좋은 정보 감사합니다!", 12, now(), now(), 4, 1);
insert into reply (rcontent, relike, cdate, udate, mno, cno) values ("부트캠프 참여 후기 궁금합니다.", 5, now(), now(), 1, 2);
insert into reply (rcontent, relike, cdate, udate, mno, cno) values ("에러가 왜 뜨냐", 26, now(), now(), 2, 4);
insert into reply (rcontent, relike, cdate, udate, mno, cno) values ("이직하고 싶습니다..", 33, now(), now(), 8, 2);
insert into reply (rcontent, relike, cdate, udate, mno, cno) values ("자격증은 어떻게 준비하셨나요?", 8, now(), now(), 6, 1);
